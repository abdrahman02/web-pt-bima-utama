...
<div class="col-lg-12 d-flex flex-row gap-5 justify-content-center">
    <a href="/laporan/use/harian" class="text-decoration-none">
        <div class="col-lg-12">
    ...
    <a href="/laporan/use/mingguan" class="text-decoration-none">
        <div class="col-lg-12">
    ...
    <a href="/laporan/use/bulanan" class="text-decoration-none">
        <div class="col-lg-12">
            <div class="card bg-primary">
                <div class="card-body d-flex justify-content-center align-items-center">
    ...
    <a href="/laporan/use/tahunan" class="text-decoration-none">
        <div class="col-lg-12">
            <div class="card bg-info">
                <div class="card-body d-flex justify-content-center align-items-center">
